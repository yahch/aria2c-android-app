...
// 判断是否安装过App,否则去市场下载
    ...
    public static String createDefaultConfig(Context context) {
        ...
        stringBuilder.append("disable-ipv6 = false\n");
        ...
        stringBuilder.append("min-split-size = 10M\n");
        ...
        stringBuilder.append("#save-session-interval = 10\n");
        ...
        stringBuilder.append("listen-port = 51413\n");
        ...
        stringBuilder.append("bt-max-peers = 200\n");
        ...
        stringBuilder.append("dht-listen-port = 60002\n");
        stringBuilder.append("enable-peer-exchange = true\n");
        stringBuilder.append("seed-ratio = 0\n");
        ...
        stringBuilder.append("#peer-id-prefix = -TR2770-\n");
