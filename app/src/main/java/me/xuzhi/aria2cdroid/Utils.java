...
// 判断是否安装过App,否则去市场下载
    ...
    public static String createDefaultConfig(Context context) {
        ...
        stringBuilder.append("bt-tracker = http://share.camoe.cn:8080/announce\n");
        ...
        stringBuilder.append("#dht-file-path = dht.dat\n");
        stringBuilder.append("#dht-file-path6 = dht6.dat\n");
        stringBuilder.append("#user-agent = <USER_AGENT>\n");
